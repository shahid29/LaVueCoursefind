...
class SeriesController extends Controller
{
    ...
    public function episode(Series $series,$episodeNumber){
        ...
        $next = $series->videos()->where('episode_number',$episodeNumber+1)->first();
        $nextVideoUrl = $next->url ?? null;
        ...
        return view('front.series.episode',compact('series','episodeNumber','video','nextVideoUrl','breadCrumbs'));
    }
}
